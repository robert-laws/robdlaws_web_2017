...
import { Container, Header, Segment, Divider, Message, Image, Icon } from 'semantic-ui-react'
					...
					<Container className="middle aligned stackable grid">
						<div className="row">
							...
							<div className="six wide right floated column">
								<Image src="../assets/images/rdl_home.jpg" size="large" bordered className="rounded" />
							</div>
						</div>
					</Container>
				</Segment>
					...
					<div className="ui equal width stackable internally celled grid">
						<div className="center aligned row">
							...
							<div className="column">
								...
								<p>
									<img src="../assets/images/reactjs.png" className="ui circular tiny middle aligned image" /> <b>ReactJS</b> - Modern Website Development
								</p>
							</div>
						</div>
					</div>
